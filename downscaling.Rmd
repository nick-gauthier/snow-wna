...
```{r}
test <- eot(era_rast, prism_rast, n = 6, type = 'rsq')
```
...
so anomalizing the rasters doesn't change teh spatial patterns, just the percent variance explained .. makes sense
